...
<video x-webkit-airplay="true" webkit-playsinline="true" preload="auto" autoplay src="http://"></v ideo>
...
### [IOS8]闪屏问题
大面积的页面内刷新时出现，这种闪屏不是位置错乱的那种闪屏，具体原因：IOS5新特性webkit-overflow-scrolling: touch可以启动快速回弹滚动（fast bounce-scroll）效果，但是它会阻止渲染直到滚动结束。
规避方案
